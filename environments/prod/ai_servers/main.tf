locals {
  ...
  vllm_gpu_count       = 2
  stable_vllm_image_id = "e71eaca8-46b8-4088-92f1-199c8b1c1f0a"
  latest_vllm_image_id = "970321bf-7e39-4512-8488-6565736e7e24"
  comfyui_gpu_count    = 2
...
module "vllm_1" {
  ...
  bastion_sg_id        = data.terraform_remote_state.bastion.outputs.all.bastion_sg_id
  external_subnet_name = data.terraform_remote_state.global_common.outputs.external_subnet_name
  flavor_id            = local.p3_2xlarge_id
  image_id             = local.stable_vllm_image_id
  resource_suffix      = "1"
  gpu_count            = local.vllm_gpu_count
  gpu_power_limit      = 250
  model_name           = "Qwen/Qwen3-Coder-30B-A3B-Instruct-FP8"
  # original qwen3-coder definition
